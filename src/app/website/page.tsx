    ...
    <div className={styles.page}>
      ...
      >
        <div className={styles.navInner}>
          ...
          <div className={styles.navActions}>
            ...
            <a href="#quote" className={styles.bookBtn}>
              Book a Repair
            </a>
          </div>
        </div>
      ...
      <section
        style={{
          ...
          textAlign: "center",
          background: "radial-gradient(ellipse 60% 70% at 50% 0%, #f0f7fe 0%, #ffffff 70%)"
        }}
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            Diagnosed free, quoted upfront, fixed by certified technicians — usually the same day.
          ...
          >
            ...
            <a href="#contact" className={styles.heroWhatsapp}>
              ...
              >
                <path d="M5 4 h4 l2 5 -2.5 1.5 a11 11 0 0 0 5 5 L15 13 l5 2 v4 a2 2 0 0 1 -2 2 A16 16 0 0 1 3 6 a2 2 0 0 1 2 -2"></path>
              </svg>
      ...
      >
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <p style={{ fontSize: 17, color: "#66727e", margin: 0 }}>
              iPhone, Android, tablets and laptops — hardware and software.
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div className={styles.serviceCard}>
              ...
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Screen Replacement
              </div>
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Cracked or dead displays swapped with genuine panels, most in under an hour.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              >
                ...
                >
                  ...
                  <line x1="7" y1="11" x2="7" y2="13"></line>
                  <line x1="11" y1="11" x2="11" y2="13"></line>
                </svg>
              </div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Battery Replacement
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Restore all-day battery life with a certified, health-tested replacement.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              >
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M13 2 L5 13 h6 l-1 9 8 -11 h-6 z"></path>
                </svg>
              </div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Charging Port
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Loose, dirty or dead ports cleaned or replaced so charging just works.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              >
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M12 3 C12 3 6.5 9.8 6.5 14 a5.5 5.5 0 0 0 11 0 C17.5 9.8 12 3 12 3 Z"></path>
                </svg>
              </div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Water Damage
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Ultrasonic cleaning and corrosion treatment to bring soaked devices back.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              >
                ...
                >
                  ...
                  <line x1="13.5" y1="6" x2="10.5" y2="18"></line>
                </svg>
              </div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Software &amp; OS Issues
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Boot loops, crashes, updates gone wrong — diagnosed and resolved.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              >
                ...
                >
                  ...
                  <path d="M5 6 v12 c0 1.7 3.1 3 7 3 s7 -1.3 7 -3 V6"></path>
                  <path d="M5 12 c0 1.7 3.1 3 7 3 s7 -1.3 7 -3"></path>
                </svg>
              </div>
              <div style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 6 }}>
                Data Recovery
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Photos, contacts and files rescued from damaged or dead devices.
              </div>
            ...
            <div className={styles.serviceCard}>
              ...
              <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#66727e", marginBottom: 12 }}>
                Microsoldering and chip-level fixes when others say it can&apos;t be saved.
              </div>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#1a6fc0" }}>quoted free</div>
            </div>
            {/* CTA card */}
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 14.5, lineHeight: 1.5, color: "#d4e8fb" }}>
                  Bring it in — diagnosis is always free and takes about 15 minutes.
                </div>
              </div>
            ...
            {[
              {
                n: "1",
                title: "Diagnose",
                body: "Drop off your device or message us. We diagnose the fault free of charge, usually within 15 minutes."
              },
              {
                n: "2",
                title: "Quote",
                body: "You get a fixed price upfront — parts, labour and warranty included. No work starts until you approve."
              },
              {
                n: "3",
                title: "Repair",
                body: "A certified technician repairs your device with genuine parts. Most jobs are done the same day."
              },
              {
                n: "4",
                title: "Collect",
                body: "We message you the moment it's ready. Every repair leaves with a 90-day warranty."
              }
            ].map((step) => (
              <div key={step.n} style={{ textAlign: "center", padding: "0 8px" }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 700, color: "#14202c", marginBottom: 8 }}>
                  {step.title}
                </div>
      ...
      >
        <div style={{ maxWidth: 1240, margin: "0 auto" }} className={styles.whyChooseGrid}>
              ...
              {[
                {
                  ...
                  body: "Trained, experienced specialists — not a kiosk with a screwdriver."
                },
                {
                  title: "Genuine parts only",
                  body: "Original or OEM-grade components — never cheap clones that fail in a month."
                },
                {
                  title: "Transparent pricing",
                  body: "Fixed quote before any work begins. The price we quote is the price you pay."
                },
                {
                  title: "Fast turnaround",
                  body: "Most screens and batteries done in under an hour, while you wait."
                },
                {
                  title: "90-day warranty",
                  body: "Every repair is covered. If anything we fixed fails, we make it right — free."
                }
              ].map((item) => (
                <div
                  key={item.title}
                ...
                >
                  ...
                  <div>
                    <div
                      style={{ fontSize: 17, fontWeight: 700, color: "#14202c", marginBottom: 4 }}
                    >
                      {item.title}
                    </div>
                    <div style={{ fontSize: 15, lineHeight: 1.55, color: "#66727e" }}>
                      {item.body}
                    </div>
                  </div>
                </div>
          ...
          <div style={{ position: "relative" }}>
            <div
              style={{ height: 520, borderRadius: 20, overflow: "hidden", position: "relative" }}
            >
              <Image
            ...
            <div
              style={{
                ...
                borderRadius: 14,
                padding: "18px 22px",
                boxShadow: "0 10px 30px rgba(20,35,50,0.14)",
                display: "flex",
                alignItems: "center",
                gap: 14
              }}
            >
              ...
              >
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M12 3 l7 3 v5 c0 4.5 -3 8.5 -7 10 c-4 -1.5 -7 -5.5 -7 -10 V6 z"></path>
                  <polyline points="9 12 11.5 14.5 15.5 9.5"></polyline>
                </svg>
              </div>
              <div>
                <div style={{ fontSize: 16, fontWeight: 700, color: "#14202c" }}>
                  90-day warranty
                </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            {["Apple", "Samsung", "Google", "Huawei", "Xiaomi", "OnePlus", "Oppo"].map((brand) => (
              <span key={brand} style={{ fontSize: 22, fontWeight: 700, color: "#aeb9c4" }}>
                {brand}
              </span>
            ))}
          </div>
            ...
            {[
              {
                initials: "SM",
                name: "Sara M.",
                sub: "iPhone 14 screen",
                quote:
                  "Shattered my iPhone screen at 10am, picked it up good as new by lunch. Fair price, no upselling, and they showed me the old parts."
              },
              {
                initials: "AK",
                name: "Ahmed K.",
                sub: "Water damage + data recovery",
                quote:
                  "Two other shops said my water-damaged Samsung was dead. Ipro Fix recovered everything — the phone AND five years of photos."
              },
              {
                initials: "RD",
                name: "Rania D.",
                sub: "Business account, 40+ devices",
                quote:
                  "We send all our company devices here. Quick quotes over WhatsApp, invoiced properly, and the repairs just last. Highly recommended."
              }
            ].map((r) => (
              <div
                key={r.name}
              ...
              >
                <div style={{ fontSize: 16, color: "#f5a623", letterSpacing: 2, marginBottom: 16 }}>
                  ★★★★★
                </div>
                <p
                  style={{ fontSize: 15.5, lineHeight: 1.6, color: "#3d4854", margin: "0 0 20px" }}
                >
                  &ldquo;{r.quote}&rdquo;
                </p>
      ...
      <section id="quote" className={styles.animSection} style={{ padding: "84px 32px", background: "#238be6" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, lineHeight: 1.55, color: "#d4e8fb", margin: "0 0 36px" }}>
            Tell us the device and the problem — we&apos;ll reply with a fixed price. No obligation,
            no diagnosis fee.
          </p>
          <div
            style={{
          ...
          <div className={styles.contactGrid}>
              ...
              >
                <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 16, lineHeight: 1.55, color: "#238be6", fontWeight: 600 }}
                    >
                      +971 00 000 0000
                    </div>
                  </div>
            ...
            <div
              style={{
                ...
                borderRadius: 16,
                padding: 36,
                boxShadow: "0 4px 20px rgba(20,35,50,0.05)"
              }}
            >
              <div style={{ fontSize: 21, fontWeight: 800, color: "#14202c", marginBottom: 4 }}>
                Send us a message
              </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div className={styles.footerGrid}>
            <div>
              ...
              >
                Professional phone &amp; device repair. Genuine parts, certified technicians, 90-day
                warranty — most repairs done the same day.
              </p>
            </div>
            <div>
