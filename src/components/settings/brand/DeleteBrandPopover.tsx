...
import { deleteBrandApi } from "@/lib/services/api/brand.service";
import { useRouter } from "next/navigation";

const DeleteBrandPopover = ({ selectedId }: { selectedId: number }) => {
  ...
  const onDeleteHandler = async () => {
    try {
      setLoading(true);
      await deleteBrandApi(selectedId);
...
export default DeleteBrandPopover;
