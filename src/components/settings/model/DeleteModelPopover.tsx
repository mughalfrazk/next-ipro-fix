...
import { deleteModelApi } from "@/lib/services/api/model.service";
import { useRouter } from "next/navigation";

const DeleteModelPopover = ({ selectedId }: { selectedId: number }) => {
  ...
  const onDeleteHandler = async () => {
    try {
      setLoading(true);
      await deleteModelApi(selectedId);
...
export default DeleteModelPopover;
