                  ...
                  <Group justify="space-between">
                    ...
                    <Divider color="black" size="sm" my="sm" variant="dashed" />
                        <Group justify="space-between" px={25}>
                          ...
                          <Text size="md" fw={600}>AED 452.99</Text>
                      </Group>
                    <Divider color="black" size="sm" my="sm" variant="dashed" />
                          <Text ta="center" size="sm">Policy:  This is the footer Message you can type your message here</Text>
                    <Divider color="black" size="sm" my="sm" variant="dashed" />
                          <Center>
                            <Image
                            w={200}
                    ...
                    <Stack justify="space-between" px={25} pt={20}>
                          <Text ta="center" size="sm">Ph: 971 5224958</Text>
                          <Text ta="center" size="sm">43, 57b Street, Umm Suqeim 1, Umm Suqeim, Dubai, United Arab Emirates</Text>
                    </Stack>
                </Paper>
