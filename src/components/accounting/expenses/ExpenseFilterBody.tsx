...
const ExpenseFilterBody = () => {
  return (
    <Stack>
      ...
      <MultiSelect label="User" placeholder="Select User Roles to Filter" data={["User 1", "User 2", "User 3"]} defaultValue={["All"]} clearable />
      <Stack align="start">
...
export default ExpenseFilterBody;
